class Header extends HTMLElement {
    ...
    connectedCallback() {
      ...
      <div class="left">
        ...
        <a class="mouse-layer-container" id="schedule" href="../html/lap_ke_hoach.html">
        <div class="mouse-layer">
        <span  class="heading1">Kế hoạch</span>

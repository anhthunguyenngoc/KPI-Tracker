...
function helpClick() {
    ...
    steps:[
        ...
        },
        {
            ...
            intro:'<p class="intro-p">Trang Theo dõi KPI sẽ giúp bạn quản lý KPI, cùng với bản thống kê KPI đạt được.</p>',
            position: "bottom"},
        {
            title:"Đến Kế hoạch",
            element: getResponsiveElementScheduleMobile(),
            intro:'<p class="intro-p">Đây sẽ là nơi để bạn thêm các nhiệm vụ và xây dựng bản kế hoạch cho riêng mình.</p>',
            position: "bottom"},
        {   
            title: "Khác",
